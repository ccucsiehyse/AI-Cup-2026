...
def main(args):
    ...
    for ep in range(1, args.epochs+1):
        ...
        if final > best_final:
            ...
            best_epoch = ep
            # keep a CPU copy so we can safely reload later
    ...
    if len(sample_df) == 0:
        # sample_submission.csv 可能只有 header，此時直接用預測結果輸出
        out = pred_df
    else:
...
if __name__ == "__main__":
    ...
    ap.add_argument("--out", default="output/submission_lstm_baseline.csv")
